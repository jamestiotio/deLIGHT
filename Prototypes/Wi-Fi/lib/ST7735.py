...
#Further modified by jamestiotio
...
#@micropython.native
# ST7735_Color565: Pass 8-bit (each) R,G,B and get back 16-bit packed color.
def TFTColor( aR, aG, aB ) :
  '''Create a 16 bit rgb value from the given R,G,B from 0-255.
     This assumes rgb 565 layout and will be incorrect for bgr.'''
  return ((aB & 0xF8) << 8) | ((aG & 0xFC) << 3) | (aR >> 3)  # aB and aR are swapped to form RGB
